...
SECRET_KEY = 'django-insecure-$am$slqq(z01dq+2ac+ko2+t)5^8*0cmdkh-&4revk8xz-e*(3'
...
CSRF_TRUSTED_ORIGINS = ["http://127.0.0.1:3000", "http://frontend:3000"]
...
# Media files settings for Google Cloud Storage
